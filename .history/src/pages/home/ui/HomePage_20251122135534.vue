...
// Правильное использование с .value
onMounted(() => {
  console.log('HomePage mounted')
  console.log('Characters:', characters.value) // используем .value
  console.log('Loading:', loading.value) // используем .value
  console.log('Error:', error.value) // используем .value
})
