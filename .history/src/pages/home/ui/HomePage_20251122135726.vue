...
// Уберите .value, так как это уже реактивные значения
onMounted(() => {
  console.log('HomePage mounted')
  console.log('Characters:', characters) // без .value
  console.log('Loading:', loading) // без .value
  console.log('Error:', error) // без .value
})
